...
2. What are the different parts of an HTTP request? 
    *Request line, Headers, White space, and Request Body*
...
8. Which part of an HTTP request contains the data being sent to the server?
    *Request line in GET methods and Request Body in POST methods.*
...
10. What are the advantages of using `curl` over the browser?
    *command line tool that can be used when no browser is available to send and receive http requests. Allows for quick testing by cybersecurity professionals*
...
33. Why would we never run `DELETE FROM <table-name>;` by itself?
    *This query will delete the entire table*
